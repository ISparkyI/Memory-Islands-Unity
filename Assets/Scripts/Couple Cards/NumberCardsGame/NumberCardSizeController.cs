...
[System.Serializable]
public class NumberCardSizeSettings
{
    public int cardCount; // Кількість всіх карток
...
public class NumberCardSizeController : MonoBehaviour
{
    [SerializeField] private NumberCardSizeSettings[] cardSizeSettings;
    ...
    private IEnumerator DelayedUpdateCardSize()
    {
        ...
        foreach (NumberCardSizeSettings settings in cardSizeSettings)
        {
            if (settings.cardCount == cardCount)
            {
